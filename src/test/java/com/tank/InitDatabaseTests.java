...
import com.tank.dao.QuestionDAO;
import com.tank.dao.UserDAO;
import com.tank.model.EntityType;
import com.tank.model.Question;
import com.tank.model.User;
import com.tank.service.FollowService;
import com.tank.service.SensitiveService;
...
public class InitDatabaseTests {
    ...
    public void contextLoads() {
        ...
        for (int i = 0; i < 11; ++i) {
            User user = new User();
            user.setHeadUrl(String.format("http://images.tank.com/head/%dt.png", random.nextInt(1000)));
